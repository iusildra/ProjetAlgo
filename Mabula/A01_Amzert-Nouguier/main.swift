 ...
 *  Intervertion des lignes et colonnes dans le print
 *  Mauvais nom de paramètre pour la saisie des destinations l.58
 *  Pas d'unwrapping au .getBilleAtPos() l.58
 *  Couleurs utilisées : "Blanc" & "Noir". Couleurs attendues : "B", "N"
 */